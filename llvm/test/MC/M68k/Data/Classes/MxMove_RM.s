	.text
	.file	"MxMove_RM.mir"
	.globl	MxMove_RM_PCI                   ; -- Begin function MxMove_RM_PCI
	.type	MxMove_RM_PCI,@function
MxMove_RM_PCI:                          ; @MxMove_RM_PCI
	.cfi_startproc
; %bb.0:
	move.b	(0,%pc,%d1), %d0
	move.b	(-1,%pc,%d1), %d0
	...
	move.l	(0,%pc,%a2), %d1
.Lfunc_end0:
	.size	MxMove_RM_PCI, .Lfunc_end0-MxMove_RM_PCI
	.cfi_endproc
                                        ; -- End function
...
.Lfunc_end1:
	...
	.cfi_endproc
                                        ; -- End function
	.globl	MxMove_RM_ARII                  ; -- Begin function MxMove_RM_ARII
	.type	MxMove_RM_ARII,@function
MxMove_RM_ARII:                         ; @MxMove_RM_ARII
	.cfi_startproc
; %bb.0:
	move.b	(0,%a0,%d1), %d0
	move.b	(-1,%a0,%d1), %d0
	...
	move.l	(0,%a2,%a2), %d1
.Lfunc_end2:
	.size	MxMove_RM_ARII, .Lfunc_end2-MxMove_RM_ARII
	.cfi_endproc
                                        ; -- End function
