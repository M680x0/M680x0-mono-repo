//===-- M680x0CallingConv.h - M680x0 Custom CC Routines ---------*- C++ -*-===//
//
...
///
/// \file
/// This file contains the custom routines for the M680x0 Calling Convention
...
inline bool CC_M680x0_Any_AssignToReg(unsigned &ValNo, MVT &ValVT, MVT &LocVT,
  ...
  static const MCPhysReg DataRegList[] = {M680x0::D0, M680x0::D1, M680x0::A0,
                                          M680x0::A1};
