...
#include "M68kGenDAGISel.inc"
  ...
  inline bool getFrameIndexAddress(M68kISelAddressMode &AM, const SDLoc &DL,
    ...
    if (AM.BaseType == M68kISelAddressMode::FrameIndexBase) {
  ...
  inline bool getSymbolicDisplacement(M68kISelAddressMode &AM,
...
bool M68kDAGToDAGISel::matchAddressBase(SDValue N,
                                          M68kISelAddressMode &AM) {
  ...
  AM.BaseType = M68kISelAddressMode::RegBase;
  AM.BaseReg = N;
  return true;
}
...
bool M68kDAGToDAGISel::matchAddressRecursively(SDValue N,
  ...
  case ISD::FrameIndex:
    if (AM.isDispAddrType() && AM.BaseType == M68kISelAddressMode::RegBase &&
        AM.BaseReg.getNode() == nullptr && doesDispFitFI(AM)) {
      AM.BaseType = M68kISelAddressMode::FrameIndexBase;
...
bool M68kDAGToDAGISel::SelectARID(SDNode *Parent, SDValue N, SDValue &Disp,
  ...
  M68kISelAddressMode AM(M68kISelAddressMode::ARID);
...
static bool isAddressBase(const SDValue &N) {
  ...
  if (Op == M68kISD::Wrapper || Op == M68kISD::WrapperPC ||
      Op == M68kISD::GlobalBaseReg) {
    return true;
  }
...
bool M68kDAGToDAGISel::SelectARII(SDNode *Parent, SDValue N, SDValue &Disp,
  ...
  M68kISelAddressMode AM(M68kISelAddressMode::ARII);
...
bool M68kDAGToDAGISel::SelectAL(SDNode *Parent, SDValue N, SDValue &Sym) {
  ...
  M68kISelAddressMode AM(M68kISelAddressMode::AL);
...
bool M68kDAGToDAGISel::SelectPCD(SDNode *Parent, SDValue N, SDValue &Disp) {
  ...
  M68kISelAddressMode AM(M68kISelAddressMode::PCD);
...
bool M68kDAGToDAGISel::SelectPCI(SDNode *Parent, SDValue N, SDValue &Disp,
  ...
  M68kISelAddressMode AM(M68kISelAddressMode::PCI);
...
bool M68kDAGToDAGISel::SelectARI(SDNode *Parent, SDValue N, SDValue &Base) {
  ...
  M68kISelAddressMode AM(M68kISelAddressMode::ARI);
