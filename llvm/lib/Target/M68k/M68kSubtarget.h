...
protected:
  ...
  // selected as well.
  enum SubtargetEnum { M00, M10, M20, M30, M40 };
...
public:
  ...
  bool isM68010() const { return SubtargetKind >= M10; }
  bool isM68020() const { return SubtargetKind >= M20; }
  bool isM68030() const { return SubtargetKind >= M30; }
